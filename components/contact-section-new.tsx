...
export function ContactSection({ data = contactData }: ContactSectionProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Thanks! Your message has been sent.") // optional feedback
  }

  // --- Custom Elizabeth Data ---
  const customData = {
    email: 'lizziemalima@gmail.com',
    phone: '', // optional: leave blank if you don’t want to display
    location: 'Harare, Zimbabwe',
    mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2381.1234567890!2d31.0500!3d-17.8292!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1931000000000000%3A0x123456789abcdef!2sHarare%2C%20Zimbabwe!5e0!3m2!1sen!2s!4v1234567890'
  }
  // --------------------------------
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
        ...
        {customData.phone && (
          <div className="flex items-center gap-3 md:gap-4 p-4 md:p-5 bg-secondary rounded-xl md:rounded-2xl border border-border hover:border-accent transition-colors group">
            ...
            <div>
              ...
              <a
                href={`tel:${customData.phone.replace(/\s/g, '')}`}
        ...
        <div className="flex items-center gap-3 md:gap-4 p-4 md:p-5 bg-secondary rounded-xl md:rounded-2xl border border-border hover:border-accent transition-colors group">
          ...
          <div>
            ...
            <p className="text-sm md:text-base text-foreground font-medium">{customData.location}</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 md:px-5 py-3 md:py-3.5 bg-secondary border border-border rounded-xl text-foreground placeholder:text-muted-foreground focus:border-accent focus:ring-2 focus:ring-accent/20 focus:outline-none transition-all text-sm md:text-base"
              placeholder="lizziemalima@gmail.com"
              required
            />
          </div>
        </div>
