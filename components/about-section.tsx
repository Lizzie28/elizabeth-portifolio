...
export function AboutSection({ data = aboutData }: AboutSectionProps) {
  ...
  const customData = {
    description: [
      "I’m a self-learning developer exploring web development, AI, and accessible technology.",
      "I enjoy learning by building small projects, experimenting with ideas, and improving through feedback.",
      "I’m especially interested in how technology can solve real-world problems and create meaningful impact."
    ],
    services: [
      {
        icon: 'Code',
        title: 'Frontend Development',
        description: 'Building responsive websites and web apps using React, Next.js, and Tailwind CSS.'
      },
      {
        icon: 'Zap',
        title: 'AI & Automation',
        description: 'Experimenting with AI-powered features and automating workflows to learn practical applications.'
      },
      {
        icon: 'Smartphone',
        title: 'UI/UX Exploration',
        description: 'Designing simple, user-friendly interfaces that prioritize accessibility and usability.'
      },
      {
        icon: 'PenTool',
        title: 'Prototyping & Learning',
        description: 'Turning ideas into small, hands-on projects to strengthen skills and understanding.'
      }
    ],
    ...
    <div className="space-y-8 md:space-y-10">
      ...
      <div>
        ...
        <div className="space-y-4 text-sm md:text-base text-muted-foreground leading-relaxed">
          {customData.description.map((paragraph, index) => (
        ...
        <div>
          ...
          <div className="relative overflow-hidden">
            <div className="flex gap-3 md:gap-4 animate-marquee">
              {[...customData.testimonials, ...customData.testimonials].map((testimonial, index) => (
        ...
        <div>
          ...
          <div className="relative overflow-hidden py-4">
            <div className="flex gap-4 md:gap-6 animate-marquee-slow">
              {[...customData.clients, ...customData.clients].map((client, index) => (
                <div
                  key={index}
